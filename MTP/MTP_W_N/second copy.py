...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        df_15Min['ema'] = talib.EMA((df_15Min['c']), timeperiod=100)

        df_15Min['callEntry'] = np.where((df_15Min['l'].shift(1) > df_15Min['c']) & (df_15Min['o'] > df_15Min['c']) & (df_15Min['o'].shift(1) > df_15Min['c'].shift(1)) & (df_15Min['ema'] < df_15Min['ema'].shift(1)), "callEntry", "")
        ...
        df_15Min['putEntry'] = np.where((df_15Min['l'].shift(1) < df_15Min['c']) & (df_15Min['o'] < df_15Min['c']) & (df_15Min['o'].shift(1) < df_15Min['c'].shift(1)) & (df_15Min['ema'] > df_15Min['ema'].shift(1)), "putEntry", "")
