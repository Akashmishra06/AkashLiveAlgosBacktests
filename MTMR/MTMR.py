...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        for timeData in df.index:
            ...
            if (self.humanTime.time() < time(9, 16)) | (self.humanTime.time() >= time(15, 26)):
                continue
                ...
                if putTradeCounter < 4 and candleColor == "green":
                    ...
                    try:
                        ...
                        if data_put_atm is not None:
                            self.entryOrder(data_put_atm["c"], put_sym_atm, lotSize, "SELL", {"Expiry": expiryEpoch, "dayOpen": {dayOpen}})
                    ...
                    try:
                        ...
                        if data_call_atm is not None:
                            ...
                            self.entryOrder(data_call_atm["c"], call_sym_atm, lotSize, "SELL", {"Expiry": expiryEpoch, "dayOpen": {dayOpen}})
...
if __name__ == "__main__":
    ...
    endDate = datetime(2026, 2, 1, 15, 30)
