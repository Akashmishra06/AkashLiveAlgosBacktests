    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        for timeData in df.index:
            ...
            if (self.humanTime.time() == time(9, 17)) or (reFetch == True):
                ...
                callSym = self.getCallSym(self.timeData, baseSym, float(df.at[lastIndexTimeData[1], "c"]), Currentexpiry, 1)
                putSym = self.getPutSym(self.timeData, baseSym, float(df.at[lastIndexTimeData[1], "c"]), Currentexpiry, 1)
