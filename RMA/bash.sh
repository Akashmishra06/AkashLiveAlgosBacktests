...
cd "/root/development/AkashLiveAlgosBacktests/RMA/RMA_2Min_N"
/usr/local/bin/pm2 start "RMA_N_2Min.py" --interpreter="/root/development/AkashLiveAlgosBacktests/venv/bin/python3" --name="RMA_2Min_N-1" --no-autorestart --time
