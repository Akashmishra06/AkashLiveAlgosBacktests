...
import numpy as np
import talib
from indicators.indicators import addIndicatorsAndSignals
        ...
        for timeData in df.index: 
            ...
            if (timeEpochSubstract in df_15Min.index):
                ...
                if df_15Min.at[last15MinIndexTimeData[1], "StochRSI_K_Smoothed"] < 20:
                    stageOne_c = True
                if stageOne_c and df_15Min.at[last15MinIndexTimeData[1], "StochRSI_K_Smoothed"] > 80:
                    stageOne_c = False
                    callEntry = True

                if df_15Min.at[last15MinIndexTimeData[1], "StochRSI_K_Smoothed"] > 80:
                    stageOne_p = True
                if stageOne_p and df_15Min.at[last15MinIndexTimeData[1], "StochRSI_K_Smoothed"] < 20:
                    stageOne_p = False
                    putEntry = True
