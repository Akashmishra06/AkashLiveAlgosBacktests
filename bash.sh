cd "/root/development/AkashLiveAlgosBacktests/MTP/MTP_W_N"
/usr/local/bin/pm2 start "MTP_W_N.py" --interpreter="/root/development/AkashLiveAlgosBacktests/venv/bin/python3" --name="MTP_W_N-11" --no-autorestart --time
