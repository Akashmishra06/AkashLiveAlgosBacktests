...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        straddleMultipleDrop = int(config.get('PSR_N_Without_DSL', 'straddleMultipleDrop'))
...
if __name__ == "__main__":
    ...
    devName = "AM"
    strategyName = config.get('PSR_N_Without_DSL', 'algoName')
    version = "v1"

    startDate = eval(config.get('PSR_N_Without_DSL', 'startDate'))
    endDate = eval(config.get('PSR_N_Without_DSL', 'endDate'))
